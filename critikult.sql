...
--
-- Hôte : localhost:3306
-- Généré le : sam. 08 avr. 2023 à 15:46
...
CREATE TABLE `jeu` (
  ...
  `couverture` varchar(100) COLLATE utf8mb4_0900_as_cs NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_as_cs;
...
CREATE TABLE `user` (
  ...
  `password` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NOT NULL,
